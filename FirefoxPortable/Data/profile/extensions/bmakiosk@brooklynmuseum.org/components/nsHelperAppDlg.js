...
const bmaLogger =
{
  ...
  ps : Components.classes["@mozilla.org/preferences-service;1"]
         ...
         .getBranch("bmakiosk.debug."),

  logMessage : function (text)
  {
    if (!this.ps.getBoolPref("enabled")) return;

    this.consoleService.logStringMessage("bma kiosk: " + text);
  },

  printMsg : function (aStr, aMsg)
  {
    if (!this.ps.getBoolPref("debug")) return;
...
nsUnknownContentTypeDialog.prototype = {
    ...
    show: function(aLauncher, aContext, aReason)  {
      ...
      bmaLogger.logMessage("RETURNING");
      return;
...
//@line 471 "/cygdrive/c/builds/tinderbox/Fx-Mozilla1.8-release/WINNT_5.2_Depend/mozilla/toolkit/mozapps/downloads/src/nsHelperAppDlg.js.in"
...
//@line 604 "/cygdrive/c/builds/tinderbox/Fx-Mozilla1.8-release/WINNT_5.2_Depend/mozilla/toolkit/mozapps/downloads/src/nsHelperAppDlg.js.in"
...
//@line 622 "/cygdrive/c/builds/tinderbox/Fx-Mozilla1.8-release/WINNT_5.2_Depend/mozilla/toolkit/mozapps/downloads/src/nsHelperAppDlg.js.in"
    },
...
//@line 645 "/cygdrive/c/builds/tinderbox/Fx-Mozilla1.8-release/WINNT_5.2_Depend/mozilla/toolkit/mozapps/downloads/src/nsHelperAppDlg.js.in"
      return aFile.path;
...
//@line 718 "/cygdrive/c/builds/tinderbox/Fx-Mozilla1.8-release/WINNT_5.2_Depend/mozilla/toolkit/mozapps/downloads/src/nsHelperAppDlg.js.in"
...
//@line 887 "/cygdrive/c/builds/tinderbox/Fx-Mozilla1.8-release/WINNT_5.2_Depend/mozilla/toolkit/mozapps/downloads/src/nsHelperAppDlg.js.in"
